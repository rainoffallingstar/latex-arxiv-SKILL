#!/usr/bin/env python3
"""Create a paper plan and/or issues CSV for an academic review paper project.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a paper plan for an academic review paper project.")
